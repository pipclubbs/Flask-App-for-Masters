...
ibex_classes = {
    ...
    "title_1": find_h2[2],
    "description_1": [find_p[2], find_p[3], find_p[4], find_p[5], find_p[6], find_p[7], find_p[8]],
    "title_2": find_h2[3],
    "description_2": [find_p[12], find_p[13], find_p[14], find_p[15]],
    "title_3": find_h4,
    "description_3": [find_p[16], find_p[17], find_p[18], find_p[19], find_p[20]],
    "title_4": find_h2[4],
    "description_4": [find_h2[6], find_h2[7]],
    "url": "https://www.ibexbouldering.co.uk/copy-of-classes-1"
}
